...
/// Leyes
///---------------
yumKaaxControllers.controller("LeyesCtrlr", ["$scope", "$http", "$q", "$routeParams", "$timeout", "$route", "authService",
            ...
            .then(
                function (result) {
                    if (result.data.Succeeded) {
                        ...
                        $scope.alertInfo = "ley ha sido grabado correctamente...";
                        $timeout(function () {
                        ...
                        $scope.showAlertInfo = true;
                        $scope.alertInfo = "Error al intentar grabar el ley...consulte al admin del sistema";
                        $timeout(function () {
                            $scope.showAlertInfo = false;
                            $scope.alertInfo = "";
                        }, 1400);
